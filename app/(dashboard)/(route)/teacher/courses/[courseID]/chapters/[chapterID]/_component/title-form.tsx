...
export const ChapterTitleForm: React.FC<ChapterTitleFormProps> = ({ initialData, courseId, chapterId }) => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            toast({
                title: "",
                description: <p className='text-green-600' >Chapter title updated successfully</p >,
            })
            setIsEditing(false);
            router.refresh();
    ...
    return (
        <div className="mt-6 border bg-neutral-50 rounded-md p-4">
            <div className="font-medium flex item-center justify-between">
                <h3 className="text-base">Chapter title</h3>
                <Button
                    variant="ghost"
                    size="sm"
